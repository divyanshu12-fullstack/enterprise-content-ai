...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("notifications_slack", sa.Boolean(), nullable=False),
        sa.Column("notifications_on_approval", sa.Boolean(), nullable=False),
        sa.Column("notifications_on_rejection", sa.Boolean(), nullable=False),
